...
public interface functions extends Collection<function>{
	 ...
	 */
	public void initFromFile(String file) throws IOException;//bufferedreader
/**
 * 
 * @param file - the file name
 * @throws IOException if the file is not writable
 */
	public void saveToFile(String file) throws IOException;//printwriter
/**
 ...
 */
	public void drawFunctions(int width, int height, Range rx, Range ry, int resolution);//open in grapfic window
/**
